...
function injectRewardStyles() {
  ...
  style.textContent = `
    ...
    .reward-ship-stage{position:relative;overflow:hidden;border-radius:18px;padding-bottom:36px}.scene-decoration-layer,.ship-decoration-layer{position:absolute;inset:0;pointer-events:none}.ship-deco{position:absolute;display:grid;place-items:center;font-weight:950}.ship-deco.flag{top:8px;right:20%;width:42px;height:32px;border-radius:9px 9px 9px 2px;background:#3264df;color:#fff;box-shadow:0 8px 18px rgb(50 100 223 / 20%)}.ship-deco.glow{left:50%;bottom:90px;width:220px;height:28px;max-width:72%;transform:translateX(-50%);border-radius:999px;background:radial-gradient(circle,#fef08a 0%,rgba(254,240,138,.25) 55%,transparent 75%);mix-blend-mode:multiply}.ship-deco.ribbon{top:10px;right:12px;min-width:64px;border-radius:999px;background:#fff1cd;color:#8a5700;padding:6px 11px;box-shadow:0 8px 18px rgb(80 60 20 / 12%);font-size:13px}.ship-decoration-caption{position:absolute;left:50%;bottom:10px;transform:translateX(-50%);width:max-content;max-width:92%;color:#60738d;font-size:13px;font-weight:800;background:rgba(255,255,255,.88);border-radius:999px;padding:4px 10px}
    .scene{position:absolute;display:grid;place-items:center}.lighthouse-base{left:9%;bottom:78px;width:28px;height:78px;background:linear-gradient(90deg,#f8fafc,#e2e8f0);border:2px solid #94a3b8;border-radius:8px 8px 3px 3px}.lighthouse-base:before{content:"";position:absolute;top:-14px;width:40px;height:18px;background:#ef4444;border-radius:12px 12px 2px 2px}.lighthouse-light{left:18%;bottom:142px;width:120px;height:36px;background:linear-gradient(90deg,rgba(254,240,138,.75),transparent);clip-path:polygon(0 35%,100% 0,100% 100%,0 65%)}.compass-ring{right:10%;bottom:80px;width:62px;height:62px;border-radius:999px;background:#fff7ed;border:4px solid #f59e0b;color:#92400e;font-weight:950}.compass-ring:after{content:"";position:absolute;width:8px;height:28px;background:#3264df;clip-path:polygon(50% 0,100% 100%,50% 78%,0 100%);top:14px;left:23px}.star{width:12px;height:12px;background:#facc15;clip-path:polygon(50% 0,62% 35%,100% 35%,69% 56%,82% 100%,50% 72%,18% 100%,31% 56%,0 35%,38% 35%)}.star.s1{left:18%;top:34px}.star.s2{right:24%;top:48px}.star.s3{left:44%;top:22px}.harbor-post{right:13%;bottom:78px;width:8px;height:74px;background:#475569;border-radius:99px}.harbor-flag{right:14%;bottom:128px;width:66px;height:34px;background:#ef4444;clip-path:polygon(0 0,100% 16%,82% 50%,100% 84%,0 100%)}
