...
@media(max-width:720px){.calendar-card{padding:12px}.calendar-head{grid-template-columns:42px 1fr 42px;gap:6px}.calendar-head h2{font-size:22px}.calendar-head button{width:42px;height:38px;min-height:38px;font-size:20px}.calendar-week,.calendar-grid{gap:5px}.calendar-cell{min-height:68px;padding:7px;border-radius:10px}.calendar-cell strong{font-size:15px}.cal-dot{width:8px;height:8px}.calendar-cell small{font-size:11px}.calendar-week b{font-size:13px}}
`;
